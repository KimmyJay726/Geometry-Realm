...
export default class Lightning4 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("lightning", "./Lightning4/costumes/lightning.svg", {
        x: 35.8743475,
        y: 40.31357750000001,
      }),
    ];

    this.sounds = [new Sound("pop", "./Lightning4/sounds/pop.wav")];
