...
export default class Wallspike3 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./Wallspike3/costumes/costume1.svg", {
        x: 49.68548030636293,
        y: 21.910021274322958,
      }),
    ];

    this.sounds = [new Sound("pop", "./Wallspike3/sounds/pop.wav")];
