...
export default class Crystal6 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("crystal-b", "./Crystal6/costumes/crystal-b.svg", {
        x: 23.51640968134697,
        y: 9.119566514314613,
      }),
    ];
    ...
    this.sounds = [
      new Sound("Magic Spell", "./Crystal6/sounds/Magic Spell.wav"),
      new Sound("collect", "./Crystal6/sounds/collect.wav"),
    ];
