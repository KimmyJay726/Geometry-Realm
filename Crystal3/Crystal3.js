...
export default class Crystal3 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("crystal-b", "./Crystal3/costumes/crystal-b.svg", {
        x: 23.51640968134697,
        y: 9.119566514314613,
      }),
    ];
    ...
    this.sounds = [
      new Sound("Magic Spell", "./Crystal3/sounds/Magic Spell.wav"),
      new Sound("collect", "./Crystal3/sounds/collect.wav"),
    ];
  ...
  *startAsClone() {
    ...
    this.direction += 10 - this.toNumber(this.stage.vars.focusfireangle);
    while (
      !(
        this.touching("edge") ||
