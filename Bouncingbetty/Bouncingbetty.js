...
export default class Bouncingbetty extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("spear2", "./Bouncingbetty/costumes/spear2.svg", {
        x: 94.25,
        y: 91.25,
      }),
      new Costume("spear3", "./Bouncingbetty/costumes/spear3.svg", {
