...
export default class Crystal5 extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("crystal-b", "./Crystal5/costumes/crystal-b.svg", {
        x: 23.51640968134697,
        y: 9.119566514314613,
      }),
    ];
    ...
    this.sounds = [
      new Sound("Magic Spell", "./Crystal5/sounds/Magic Spell.wav"),
      new Sound("collect", "./Crystal5/sounds/collect.wav"),
    ];
  ...
  *startAsClone() {
    ...
    this.direction -= 20 - this.toNumber(this.stage.vars.focusfireangle) * 2;
    while (
      !(
        this.touching("edge") ||
