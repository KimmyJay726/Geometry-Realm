...
export default class Star4 extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("Star", "./Star4/costumes/Star.png", { x: 375, y: 360 }),
      new Costume("Sun", "./Star4/costumes/Sun.svg", {
        x: 65.25,
        y: 67.56815354655767,
      }),
      new Costume("Sun2", "./Star4/costumes/Sun2.svg", {
        x: 56.95238095238096,
        y: 54.51851851851853,
      }),
      new Costume("costume1", "./Star4/costumes/costume1.svg", {
        x: 267.3552926644452,
